...
let employee = new Employee ('Traci', 'Crawford', 'toocool4skool@gmail.com', 21);
  //Employee.makeWidget ('traci', 'crawford')
employee.makeWidget()  
//("this.firstName + this.lastName + 'Widget' ")
...
class ProgressiveManager extends Manager {
  ...
  hire (employee) {
    ...
    if (this.reports.length === 0) {
      ...
      (this.reports.length > 0 && this.reports.length < 4) {
      this.title = 'Barely Manager';
    } else if 
      (this.reports.length > 3 && this.reports.length < 11) {
      this.title = 'Mostly Manager'; 
    } else if
    (this.reports.length > 10 && this.reports.length < 51) {
    this.title = 'Manager'; 
    } else if
    (this.reports.length > 50 && this.reports.length < 101) {
